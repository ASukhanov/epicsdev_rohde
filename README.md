# epicsdev_rohde. Under development.
(Note: Current version 1.0.0 was generated by Github Copilot.)<br>
Python-based EPICS PVAccess server for Rohde&Schwarz oscilloscopes.<br>
